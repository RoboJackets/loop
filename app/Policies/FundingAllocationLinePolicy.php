...
class FundingAllocationLinePolicy
{
     ...
     * @psalm-pure
     */
    public function view(User $user, FundingAllocationLine $fundingAllocationLine): true
    {
        return true;
    }
     ...
     * @psalm-pure
     */
    public function forceDelete(User $user, FundingAllocationLine $fundingAllocationLine): false
    {
        return false;
    }
}
